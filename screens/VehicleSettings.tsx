  ...
  return (
    <div className="flex flex-col h-full bg-background-dark animate-fadeIn">
      <header className="flex items-center justify-between p-4 pt-12 z-20">
        ...
        <h1 className="text-xl font-black">Vehicle Settings</h1>
        <div className="size-11" />
      </header>

      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8">
        <section>
          <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4">Vehicle Category</h2>
          <div className="grid grid-cols-3 gap-3">
             {[
               { id: 'car', label: 'Personal', icon: 'directions_car' },
        ...
        <section className="space-y-4">
          <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4">Core Info</h2>
          <div className="bg-surface-dark rounded-3xl border border-white/5 p-2 space-y-1">
             <div className="p-4 flex items-center justify-between border-b border-white/5">
                <span className="text-sm font-bold text-slate-300">Model Name</span>
             ...
             <div className="p-4 flex items-center justify-between">
                <span className="text-sm font-bold text-slate-300">Odometer</span>
        ...
        <section>
          <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4">Primary Fuel</h2>
