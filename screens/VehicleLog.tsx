      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8 pb-32">
        ...
        <button className="w-full h-20 bg-primary hover:bg-primary-dark text-background-dark rounded-[2rem] shadow-xl shadow-primary/20 flex items-center justify-between px-8 transition-all active:scale-[0.98]">
           <div className="flex items-center gap-4">
             ...
             <span className="text-xl font-black">New Fuel Log</span>
           </div>
        ...
        <div className="grid grid-cols-2 gap-4">
           <div className="p-6 rounded-[2.5rem] bg-surface-dark border border-white/5 text-left">
              ...
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Avg. Usage</p>
           ...
           <div className="p-6 rounded-[2.5rem] bg-surface-dark border border-white/5 text-left">
              ...
              <p className="text-[9px] font-black text-slate-500 mt-3 italic">Last 30 days</p>
           </div>
        </div>
        ...
        <div className="p-6 rounded-[2.5rem] bg-surface-dark border border-white/5">
           <div className="flex justify-between items-center mb-6">
              <h3 className="font-black text-white">Efficiency Trend</h3>
              <span className="text-[10px] font-black text-primary uppercase">6 Months</span>
           </div>
           ...
           <div className="flex justify-between mt-4 px-2 text-[10px] font-black text-slate-600 uppercase">
              <span>May</span><span>Aug</span><span>Oct</span>
           </div>
        </div>

        {/* History List */}
        <div className="space-y-4">
           <h3 className="font-black text-white px-2">Recent Logs</h3>
