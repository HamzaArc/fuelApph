    ...
    <div className="flex flex-col h-full bg-background-dark animate-fadeIn">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8 pb-32">
        ...
        <button
          ...
          className="w-full h-20 bg-primary hover:bg-primary-dark text-background-dark rounded-[2rem] shadow-xl shadow-primary/20 flex items-center justify-between px-8 transition-all active:scale-[0.98]"
        >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-6 rounded-[2.5rem] bg-surface-dark border border-white/5 text-left">
            ...
            <p className="text-2xl font-black text-white leading-none">--<span className="text-[10px] ml-1 opacity-50">L/100km</span></p>
          ...
          <div className="p-6 rounded-[2.5rem] bg-surface-dark border border-white/5 text-left">
            ...
            <p className="text-2xl font-black text-white leading-none">{totalCost.toLocaleString()}<span className="text-[10px] ml-1 opacity-50">DH</span></p>
        ...
        <div className="space-y-4">
          ...
          {loading ? (
            <div className="flex justify-center py-4"><div className="animate-spin size-6 border-2 border-primary border-t-transparent rounded-full" /></div>
          ) : logs.length > 0 ? (
            logs.map(log => (
              <LogItem
                key={log.id}
            ...
            <div className="text-center text-slate-500 text-xs py-4">No logs yet. Add your first refuel!</div>
          )}
        </div>
      </div>
